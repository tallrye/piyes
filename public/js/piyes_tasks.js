$(document).ready(function(){
    $("#todo, #completed").sortable({
        ...
        update: function( event, ui ) {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: globalBaseUrl + '/piyes/tasks/order',
            ...
            $.ajax({
                ...
                type: 'POST',
                url: globalBaseUrl + '/piyes/tasks/orderCompleted',
                success: function(response) {
                    //
                },
            });
        ...
        stop: function( event, ui ) {
            toastr.success('Task lists updated.');
        }
    ...
    $(document).delegate('.updateTaskForm', 'submit', function(e){
        ...
        request = $.ajax({
            data: serializedData,
            type: 'POST',
            url: globalBaseUrl + '/piyes/tasks/update',
            success: function (response) {
                $("#currentTaskList").load(location.href + " #currentTaskList");
                toastr.success(response);
            },
