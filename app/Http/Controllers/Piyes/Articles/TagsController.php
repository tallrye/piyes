...
use App\Models\Piyes\Articles\Tag as PageModel;
...
class TagsController extends BaseController
{
    ...
    {
        checkPermissionFor('manage_'.$this->pageUrl);
        return view('piyes.'.$this->pageUrl.'.create');
    }
    ...
    {
        checkPermissionFor('manage_'.$this->pageUrl);
        return view('piyes.'.$this->pageUrl.'.edit', compact('record'));
    }
    ...
    {
        checkPermissionFor('manage_'.$this->pageUrl);
        if(parent::handleDestroy($this->model, $record, $this->urlColumn, false, false)){
