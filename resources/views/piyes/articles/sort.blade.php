                    ...
                    <div id="currentTaskList">
	                    <ul class="sortable-list connectList agile-list" id="sort-list">
	                        ...
	                        <li class="warning-element" id="{{ $record->id }}">
	                            ...
	                            <input class="input form-control editTaskInput" type="text" name="description" value="{{ $record->title }}" autocomplete="off">
	                            <span class="currentTaskDescription">{{ $record->title }}</span>
