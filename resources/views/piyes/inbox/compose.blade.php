        ...
        <div class="col-lg-9 animated fadeInRight">
            <div class="mail-box-header">
                <div class="pull-right tooltip-demo">
                    <form style="display: none !important;" id="draftForm" method="POST" action="{{ route('piyes.inbox.save-draft') }}">
                    {{ csrf_field() }}
                    ...
                    <a href="mailbox.html" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="top" title="Discard email"><i class="fa fa-times"></i> Discard</a>
                </div>
                <h2>
                    New Mail
                </h2>
            ...
            <div class="mail-box">
                <form class="form-horizontal" id="composerForm" method="POST" action="{{ route('piyes.inbox.send') }}">
                    ...
                    <div class="mail-body text-right tooltip-demo">
                        <button type="submit" id="sendMailBtn" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="Send"><i class="fa fa-envelope"></i> Send</button>
                    </div>
                </form>
                <div class="clearfix"></div>
            </div>
